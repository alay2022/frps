# frps
## 项目简介----本项目fork自[stilleshan/frps](https://github.com/stilleshan/frps)
...
# 以下为国内镜像
wget https://github.ioiox.com/alay2022/frps/raw/branch/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
...
# 以下为国内镜像
wget https://github.ioiox.com/alay2022/frps/raw/branch/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
```
...
#### 修改 frps_linux_install.sh 脚本
`FRP_VERSION=0.60.0` 可根据原版项目更新自行修改为最新版本.  
`REPO=alay2022/frps` 由于 **fork** 到你自己的仓库,需修改`alay2022`为你的 GitHub 账号ID.
...
# git clone 本仓库
git clone https://github.ioiox.com/alay2022/frps
# 国内镜像
